...
class GameConfig(Config):
    ...
    def __init__(self):
        ...
        pay_group = {
            ...
            (t1, "H1"): 1.43, (t2, "H1"): 3.43, (t3, "H1"): 8.6,
            (t4, "H1"): 22.92, (t5, "H1"): 71.6, (t6, "H1"): 286.42,
            # H2 — Gold Bar
            (t1, "H2"): 1.0, (t2, "H2"): 2.15, (t3, "H2"): 5.15,
            (t4, "H2"): 14.32, (t5, "H2"): 37.24, (t6, "H2"): 171.85,
            # H3 — Sheriff Badge
            (t1, "H3"): 0.57, (t2, "H3"): 1.43, (t3, "H3"): 3.43,
            (t4, "H3"): 8.6, (t5, "H3"): 22.92, (t6, "H3"): 85.92,
            # H4 — Horseshoe
            (t1, "H4"): 0.4, (t2, "H4"): 1.0, (t3, "H4"): 2.29,
            (t4, "H4"): 5.15, (t5, "H4"): 14.32, (t6, "H4"): 51.56,
            # L1 — Diamond
            (t1, "L1"): 0.2, (t2, "L1"): 0.43, (t3, "L1"): 1.0,
            (t4, "L1"): 2.29, (t5, "L1"): 5.73, (t6, "L1"): 20.05,
            # L2 — Heart
            (t1, "L2"): 0.2, (t2, "L2"): 0.43, (t3, "L2"): 1.0,
            (t4, "L2"): 2.29, (t5, "L2"): 5.73, (t6, "L2"): 20.05,
            # L3 — Club
            (t1, "L3"): 0.23, (t2, "L3"): 0.52, (t3, "L3"): 1.29,
            (t4, "L3"): 3.43, (t5, "L3"): 8.6, (t6, "L3"): 31.5,
            # L4 — Spade
            (t1, "L4"): 0.23, (t2, "L4"): 0.52, (t3, "L4"): 1.29,
            (t4, "L4"): 3.43, (t5, "L4"): 8.6, (t6, "L4"): 31.5,
            # DS — wild, unreachable as cluster start (kept for safety)
            (t1, "DS"): 0.57, (t2, "DS"): 1.43, (t3, "DS"): 3.43,
            (t4, "DS"): 8.6, (t5, "DS"): 22.92, (t6, "DS"): 85.92,
            # DB — wild, unreachable
            (t1, "DB"): 1.0, (t2, "DB"): 2.15, (t3, "DB"): 5.15,
            (t4, "DB"): 14.32, (t5, "DB"): 37.24, (t6, "DB"): 171.85,
        }

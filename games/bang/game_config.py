...
class GameConfig(Config):
    ...
    def __init__(self):
        ...
        pay_group = {
            ...
            (t1, "H1"): 1.64, (t2, "H1"): 3.94, (t3, "H1"): 9.89,
            (t4, "H1"): 26.36, (t5, "H1"): 82.34, (t6, "H1"): 329.38,
            # H2 — Gold Bar
            (t1, "H2"): 1.15, (t2, "H2"): 2.47, (t3, "H2"): 5.92,
            (t4, "H2"): 16.47, (t5, "H2"): 42.83, (t6, "H2"): 197.63,
            # H3 — Sheriff Badge
            (t1, "H3"): 0.66, (t2, "H3"): 1.64, (t3, "H3"): 3.94,
            (t4, "H3"): 9.89, (t5, "H3"): 26.36, (t6, "H3"): 98.81,
            # H4 — Horseshoe
            (t1, "H4"): 0.46, (t2, "H4"): 1.15, (t3, "H4"): 2.63,
            (t4, "H4"): 5.92, (t5, "H4"): 16.47, (t6, "H4"): 59.29,
            # L1 — Diamond
            (t1, "L1"): 0.23, (t2, "L1"): 0.49, (t3, "L1"): 1.15,
            (t4, "L1"): 2.63, (t5, "L1"): 6.59, (t6, "L1"): 23.06,
            # L2 — Heart
            (t1, "L2"): 0.23, (t2, "L2"): 0.49, (t3, "L2"): 1.15,
            (t4, "L2"): 2.63, (t5, "L2"): 6.59, (t6, "L2"): 23.06,
            # L3 — Club
            (t1, "L3"): 0.26, (t2, "L3"): 0.6, (t3, "L3"): 1.48,
            (t4, "L3"): 3.94, (t5, "L3"): 9.89, (t6, "L3"): 36.22,
            # L4 — Spade
            (t1, "L4"): 0.26, (t2, "L4"): 0.6, (t3, "L4"): 1.48,
            (t4, "L4"): 3.94, (t5, "L4"): 9.89, (t6, "L4"): 36.22,
            # DS — wild, unreachable as cluster start (kept for safety)
            (t1, "DS"): 0.66, (t2, "DS"): 1.64, (t3, "DS"): 3.94,
            (t4, "DS"): 9.89, (t5, "DS"): 26.36, (t6, "DS"): 98.81,
            # DB — wild, unreachable
            (t1, "DB"): 1.15, (t2, "DB"): 2.47, (t3, "DB"): 5.92,
            (t4, "DB"): 16.47, (t5, "DB"): 42.83, (t6, "DB"): 197.63,
        }
